...
#define Z_MIN_PIN          12  ////changed from 18/////
#define Z_MAX_PIN          19
...
#define FILWIDTH_PIN        5 // ANALOG NUMBERING
  ...
  #define Z_MIN_PROBE_PIN  12  ////changed from 32////
#endif
  ...
  #define FAN_PIN           43 // (Sprinter config) 
...
#define PS_ON_PIN          -1///////changed from 12 (burnt out)////////
...
#if MB(RAMPS_14_EFF) || MB(RAMPS_13_EFF)
  #define HEATER_0_PIN      10  //////////////Changed from 8/////////
#else
...
#else
  #define HEATER_1_PIN      7   // EXTRUDER 2 (FAN On Sprinter) ///changed from 9//
#endif
