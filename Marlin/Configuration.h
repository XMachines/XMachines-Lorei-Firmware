...
#define STRING_CONFIG_H_AUTHOR "(XMachines)" // Who made the changes.
...
// :[1,2,3,4]
#define EXTRUDERS EXTRUDER_COUNT
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // LOREI V6 Style Hot End
  #define  DEFAULT_Kp 15.55   ///old 20.19
  #define  DEFAULT_Ki 1.24    /// old 2.70
  #define  DEFAULT_Kd 48.93   ///old 37.72
...
#define PIDTEMPBED   /////default marlin is uncommented
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //LOREI Heated Bed
  #define  DEFAULT_bedKp 473.88
  #define  DEFAULT_bedKi 81.70
  #define  DEFAULT_bedKd 687.12
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  // #define X_PROBE_OFFSET_FROM_EXTRUDER 10    /////Uno 0   Duo 10
  ...
  #define FIX_MOUNTED_PROBE   /////change 10/28/16 was not defined
  ...
  //#define MECHANICAL_PROBE   /////change 10/28 was defined
...
// - Prevent Z homing when the Z probe is outside bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT 8
    #define Z_SAFE_HOMING_Y_POINT 80
  #elif (EXTRUDER_COUNT == 2)
    #define Z_SAFE_HOMING
    #define Z_SAFE_HOMING_X_POINT 21
    #define Z_SAFE_HOMING_Y_POINT 83
  #endif
#endif
    
//Z Safe Homing is not needed for the Duo
...
#define HOMING_FEEDRATE {60*60, 60*60, 4*60, 0}  // set the homing speeds (mm/min) default 50
...
#define DEFAULT_MAX_ACCELERATION      {1000,1000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot. //// {1000,1000,100,10000} old

#define DEFAULT_ACCELERATION          1000    // X, Y, Z and E acceleration in mm/s^2 for printing moves  ///1000 old
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves

// The speed change that does not require acceleration (i.e. the software might assume it can be done instantaneously)
#define DEFAULT_XYJERK                15    // (mm/sec) ////was 20
...
//
#define ENCODER_PULSES_PER_STEP 4   ////8/24

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1  ///8/24
